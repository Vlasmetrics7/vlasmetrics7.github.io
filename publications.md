    ...
    <div class="btn-row">
      ...
      <div class="dropdown-container">
        ...
        <div id="media-ECOSTAT21B" class="dropdown-menu">
          <a href="https://www.dropbox.com/scl/fi/dqzsfzyrj4k2lwurij2pq/job-market-seminar.pdf?rlkey=d1yhfx7wmipk7mqbwn82dgqka&st=2bik03mq&dl=0" target="_blank">Slides (PDF)</a><br>
        </div>
      </div>
      ...
      <div class="btn-row">
        ...
        <div class="dropdown-container">
          ...
          <div id="wp-ECO2021" class="dropdown-menu">
            <a href="https://vbn.aau.dk/en/publications/air-pollution-and-mobility-what-carries-the-covid-19-death-toll"
               target="_blank">Aalborg WP 2020</a><br>
            <a href="https://pure.au.dk/ws/portalfiles/portal/202904282/rp20_15.pdf"
               target="_blank">CREATES WP 2020</a>
          </div>
        </div>
...
<pre><code>@article{lopez2021remittances,
  ...
  author={López-Marmolejo, Arnoldo and Rodríguez-Caballero, Carlos Vladimir and Ventosa-Santaularia, Daniel},
...
<pre><code>@article{vera2023air,
  ...
  author={Vera-Vald{\'e}s, J Eduardo and Rodr{\'\i}guez-Caballero, Carlos Vladimir},
  journal={Atm{\'o}sfera},
  volume={36},
  number={2},
  pages={343--354},
  ...
  <div class="pub-card">
    ...
    <div class="pub-info">
      ...
      <strong>Wavelet Estimation for Factor Models with Time-Varying Loadings</strong><br>
      ...
      <div class="btn-row">
        ...
        <div class="dropdown-container">
          ...
          <div id="wp-WAV21" class="dropdown-menu">
            ...
            <a href="https://repositorio.usp.br/bitstreams/6d4a500b-e34a-4616-a37d-99e4cb4ac9c8"
               target="_blank">USP WP 2021</a>
          </div>
        </div>
      ...
      <div class="btn-row">
        ...
        <div class="dropdown-container">
          ...
          <div id="wp-ECOSTAT21" class="dropdown-menu">
            <a href="https://pure.au.dk/ws/portalfiles/portal/104266163/rp16_31.pdf"
               target="_blank">CREATES WP 2016</a><br>
          </div>
        </div>
